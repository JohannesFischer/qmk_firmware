...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LALT, KC_LGUI, KC_BSPC, KC_FN2, KC_SPC,  KC_RGUI, KC_RALT
  ),
  [_FN] = LAYOUT(
    ...
    _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY, _______, _______, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT, _______, _______,
  ...
  [_FN2] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_END,  _______, _______, _______,
