...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    [_DVORAK] = LAYOUT(
      ...
      KC_LSFT, KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X,              KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,    MT_SHIFT_ENTER,
      ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, LOWER,   KC_SPC,            KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
   ...
   */
    [_LOWER] = LAYOUT(
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______,           _______, _______, KC_7,    KC_8,   KC_9, KC_BSPC,
      ...
      _______, _______, _______, _______, _______, _______,           _______, _______, KC_HOME, KC_DOT, KC_0, KC_END
    ),
